...
def to_word_text(df):
    lines = [
        ...
        "",
        "Model V1.6 Final | Input: Ash, C, H, O, N, S",
    ]
...
.leaf-logo::before {
    ...
    left:8px;
    top:0px;
    background:linear-gradient(145deg,#7ec84a,#2f9e39);
...
.leaf-logo::after {
    ...
    left:24px;
    top:14px;
    background:linear-gradient(145deg,#52b947,#18853a);
    border-radius:80% 0 80% 0;
...
<div class="hero">
  <div class="brand-wrap">
    <div class="app-logo">
      <div class="leaf-logo"><div class="leaf-stem"></div></div>
    </div>
    <div>
...
st.markdown(
    """
<div class="footer">
  <b>Biothermodata</b> &nbsp; | &nbsp; Model V1.6 Final &nbsp; | &nbsp; © 2025 Nanjing Tech University
</div>
""",
    unsafe_allow_html=True,
)
